...
const LAB_CHAOS = [
  ...
  'The beaker is vibrating suspiciously',
  'Creativity compound spilled on the floor',
  'Someone fed caffeine to the AI again',
  'Lab hamster is observing the experiment',
  'Warning: inspiration levels rising rapidly',
  'The pixels are starting to argue',
  'We may have invented a new color',
  'AI scientist insists this is "totally normal"',
  'The creativity reactor is humming loudly',
  'A mysterious glow has appeared',
]
